...
data class RunOptions(val workspace: Path, val binary: String = "codex", val timeoutSeconds: Long = 300, val noBrowser: Boolean = false) {
    companion object {
        fun parse(args: Array<String>): RunOptions {
            ...
            return RunOptions(workspace.toRealPath(), binary, timeout, noBrowser)
        }
    }
}
